...
<div class="container-fluid" xmlns="http://www.w3.org/1999/html">
	...
	<div class="row-fluid">
		...
		<div class="span9">
				...
				<div class="well">
					...
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="home">
							...
							<input type="text" value="<?php echo $response->goods['goods_sn'];?>" name="goods_sn" class="input-xlarge" >
							<label>Goods Name:</label>

							<input type="text" value="<?php echo $response->goods['goods_name'];?>" name="goods_name" class="input-xlarge">
							...
							<label for="">Goods Brand:</label>
							<select  name="brand_id" class="input-xlarge">
								<option value="0">please select</option>
							...
							<input type="text" value="<?php echo $response->goods['weight'];?>"" name="goods_weight" class="input-xlarge" >

							<label for="">Price:</label>
							<input type="text" value="<?php echo $response->goods['price'];?>"" name="price" class="input-xlarge" >

							<label>Description</label>
                            <textarea value="Smith" rows="3" class="input-xlarge" name="desc">
                                <?php echo $response->goods['describle'];?>
                            </textarea>
			...
			<?php lib_functions::image($response->goods['image']);?>
...
//        var shop_id = form['shop_id'].value;
		...
		// alert(url);
		$.post(url,{'goods_id':goods_id,'goods_sn':goods_sn,'goods_name':goods_name,'cat_id':cat_id,
